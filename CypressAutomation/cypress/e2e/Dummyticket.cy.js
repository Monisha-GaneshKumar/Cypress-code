describe("Validate Dummy ticket site",()=>{
    it("Assertion in all  fields",()=>{
        ...
        // Give Inputs to input fields
            // Passenger details
        cy.get('#travname').should('be.visible').should('exist').type("Moni")
        ...
        // Billing details
        cy.get('#billname').should('be.visible').should('exist').type("Moni")
        cy.get('#billing_phone').should('be.visible').should('exist').type("9841150672")
        cy.get('#billing_email').should('be.visible').should('exist').type("Moni@gmail.com")
        ...
        cy.wait(2000)
        cy.get('#cardOwnerName').should('exist').should('be.visible').type("Moni")
        cy.wait(2000)
